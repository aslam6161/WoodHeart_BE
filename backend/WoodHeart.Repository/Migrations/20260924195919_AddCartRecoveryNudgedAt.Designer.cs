...
namespace WoodHeart.Repository.Migrations
{
    ...
    [Migration("20260924195919_AddCartRecoveryNudgedAt")]
    partial class AddCartRecoveryNudgedAt
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WoodHeart.Domain.Entity.Ordering.Cart", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("RecoveryNudgedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("recovery_nudged_at");
